    ...
    <form action="{{ route('timesheet.store') }}" method="POST">
        ...
        <label class="font-semibold mb-1 text-sm">WEEK:</label>
            <input type="text" name="week" placeholder="WEEK"
                class="w-28 bg-gray-100 border border-gray-300 rounded-xl px-3 py-2" required />
        </div>
        ...
        <label class="font-semibold mb-1 text-sm">POSITION:</label>
            <input type="text" name="position" value="Finance Exec"
            ...
            <table class="w-full border-collapse border border-white">
                ...
                <tbody id="timesheet-body" style="background-color: #F3F3F3;">
                    ...
                    <tr class="border-b border-gray-300">
                        <td class="py-3 px-4">
                            <input type="date" name="rows[0][date]" class="w-full bg-white border border-gray-300 rounded px-2 py-1" required>
                        </td>

                        <td class="py-3 px-4">
                            <select name="rows[0][project]" class="w-full bg-white border border-gray-300 rounded px-2 py-1" required>
                        ...
                        <td class="py-3 px-4">
                            <input type="text" name="rows[0][task]" placeholder="Enter task"
                                   class="w-full bg-white border border-gray-300 rounded px-2 py-1" required>
                        </td>

                        <td class="py-3 px-4">
                            <input type="time" name="rows[0][start]" class="w-full bg-white border border-gray-300 rounded px-2 py-1" required>
                        </td>

                        <td class="py-3 px-4">
                            <input type="time" name="rows[0][end]" class="w-full bg-white border border-gray-300 rounded px-2 py-1" required>
                        </td>
