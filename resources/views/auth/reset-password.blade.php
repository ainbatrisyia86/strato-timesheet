<x-guest-layout>
    <form method="POST" action="{{ route('password.store') }}"
        x-data="{ 
            ...
            get canSubmit() { return this.email.trim() !== '' && this.isPasswordValid && this.isMatch }
        }"
    >
        @csrf
        ...
        <div class="mt-4">
            ...
            <div class="mt-1 flex items-center overflow-hidden border rounded-md shadow-sm transition-all duration-200"
                ...
                <button type="button" @click="showPassword = !showPassword" 
                    class="flex items-center justify-center px-4 py-2 border-l border-gray-300 bg-gray-50 text-gray-500 hover:bg-gray-100 transition-colors">
                    <svg x-show="!showPassword" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"/></svg>
                    <svg x-show="showPassword" x-cloak class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 3l18 18M13.875 18.825A10.05 10.05 0 0112 19c-4.478 0-8.268-2.943-9.543-7a9.97 9.97 0 011.563-3.029"/></svg>
                </button>
            </div>
        ...
        <div class="mt-4">
            ...
            <div class="mt-1 flex items-center overflow-hidden border rounded-md shadow-sm transition-all duration-200"
                ...
                <button type="button" @click="showConfirm = !showConfirm" 
                    ...
                    <svg x-show="showConfirm" x-cloak class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 3l18 18M13.875 18.825A10.05 10.05 0 0112 19c-4.478 0-8.268-2.943-9.543-7a9.97 9.97 0 011.563-3.029"/></svg>
                </button>
            </div>
        ...
        <div class="flex items-center justify-end mt-6">
            <x-primary-button 
                ...
                class="px-6 py-3 uppercase tracking-widest text-xs">
                {{ __('Reset Password') }}
            </x-primary-button>
        </div>
    </form>
